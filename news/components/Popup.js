...
const Popup = ({ newDetails, setPopUpToggle, isDarkMode }) => {
  return (
    <>
      <div
        className={`${
          isDarkMode === true ? "bg-slate-800" : "bg-white"
        } w-[380px] md:w-[600px] rounded-lg aspect-ratio: 4/3 p-2 mt-[150px] z-100 font-kanit`}
      >
        <div
        ...
        <div className="">
          <img className="rounded-lg" src={newDetails.imag_url} />
        </div>
        <div
        ...
        <div className="p-4 border-b-4 border-rose-500">
          {newDetails.content}
        </div>
      </div>
    </>
